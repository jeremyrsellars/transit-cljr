// From https://github.com/neuecc/MessagePack-CSharp/blob/ffc18319670d49246db1abbd05c404a820280776/src/MessagePack.UnityClient/Assets/Scripts/MessagePack/SequencePool.cs
using System;
...
namespace Sellars.Transit.Impl
{
    ...
    internal class SequencePool
    {
        ...
        /// </summary>
        /// <remarks>
        /// We use a <see cref="maxSize"/> that allows every processor to be involved in serialization concurrently,
