...
namespace Sellars.Transit.Cljr.Impl
{
    ...
    internal partial class WriterFactory
    {
        ...
        internal static void SetSubHandler(IImmutableDictionary<Type, IWriteHandler> handlers, AbstractEmitter abstractEmitter) 
        {
        ...
        internal static IImmutableDictionary<Type, IWriteHandler> GetVerboseHandlers(IImmutableDictionary<Type, IWriteHandler> handlers) 
        {
