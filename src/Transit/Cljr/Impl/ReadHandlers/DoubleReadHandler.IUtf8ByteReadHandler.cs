...
namespace Beerendonk.Transit.Impl.ReadHandlers
{
    ...
    /// </summary>
    internal partial class DoubleReadHandler : IUtf8ByteSpanReadHandler, IUtf8ByteSequenceReadHandler
    {
        ...
        public static bool TryParseUtf8ByteSequence(ReadOnlySequence<byte> utf8, out double value)
        {
        ...
        public static bool TryParseUtf8ByteSpan(ReadOnlySpan<byte> utf8, out double value) =>
