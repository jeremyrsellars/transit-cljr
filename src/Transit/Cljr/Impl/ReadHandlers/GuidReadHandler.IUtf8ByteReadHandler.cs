...
namespace Beerendonk.Transit.Impl.ReadHandlers
{
    ...
    /// </summary>
    internal partial class GuidReadHandler : IUtf8ByteSpanReadHandler, IUtf8ByteSequenceReadHandler
    {
        ...
        public static bool TryParseUtf8ByteSequence(ReadOnlySequence<byte> utf8, out Guid value)
        {
        ...
        public static bool TryParseUtf8ByteSpan(ReadOnlySpan<byte> utf8, out Guid value) =>
